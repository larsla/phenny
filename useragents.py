...
'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_6; en-US) AppleWebKit/530.5 (KHTML, like Gecko) Chrome/ Safari/530.1'
]
...
class UserAgent:
  def random(self):
    return useragents[random.randint(1, len(useragents))]
